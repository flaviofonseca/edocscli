...
function criarArquivosJava (fs, casoUso, folderDst, nomeTabela, log, pacote) {
  ...
  function criarRepository () {
    ...
    conteudo =
      ...
      '    }\n' +
      '   @Override\n' +
      '    public HelperFilterCommomPesquisar getHelperFilterCommomPesquisar(PesquisarDTO pesquisarDTO) {\n' +
      '        return null;\n' +
      '    }' +
      '}\n'
  ...
  function criarService () {
    conteudo =
      ...
      '\t}\n' +
      '\t@Override\n' +
      '\tpublic Optional<' + nomeTabela + '> findCompleteObjectByIdAutoComplete(Long id) {\n' +
