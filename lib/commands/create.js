...
module.exports = function (dep) {
    ...
    cmd.desc = 'Criar arquivos arquitetura edocscli -t: <casoUso> tabela tipo -c -p -s '
    cmd.builder = {
        tabela: {
            alias: 't',
...
function criarArquivosJava(fs, casoUso, folderDst, nomeTabela, log) {
    ...
    function criarService() {
        conteudo =
            ...
            '\n' +
            '@Service\n' +
            'public class ' + nomeTabela + 'Service extends GenericServiceImpl<' + nomeTabela + ', PesquisarDTO> {\n' +
            '\n' +
