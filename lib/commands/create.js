...
module.exports = function (dep) {
  ...
  cmd.desc = 'Criar arquivos arquitetura edocscli -t: <casoUso> tabela tipo packageName'
  cmd.builder = {
    tabela: {
      alias: 't',
  ...
  cmd.handler = function (argv) {
    const {casoUso, tabela, pesquisa, cadastro, service, tipo, packageName} = argv
    ...
    try {
      ...
      if (tipo === 'java') {
        ...
        criarArquivosJava(fs, casoUso, folderDst, nomeTabela, log, packageName)
      } else {
...
function criarArquivosJava (fs, casoUso, folderDst, nomeTabela, log, packageName) {
  ...
  function criarEntidade () {
    conteudo =
      'package ' + packageName + '.app.' + nameFolder + ';\n' +
      '\n' +
      'import javax.persistence.Column;\n' +
      'import javax.persistence.Entity;\n' +
      'import javax.persistence.Table;\n' +
      '\n' +
      'import ' + packageName + '.arquitetura.model.Entidade;\n' +
      '\n' +
  ...
  function criarController () {
    conteudo =
      'package ' + packageName + '.app.' + nameFolder + ';\n' +
      '\n' +
      'import ' + packageName + '.arquitetura.controller.GenericControllerImpl;\n' +
      'import org.springframework.beans.factory.annotation.Autowired;\n' +
      'import org.springframework.web.bind.annotation.RequestMapping;\n' +
      'import org.springframework.web.bind.annotation.RestController;\n' +
      'import ' + packageName + '.arquitetura.controller.PesquisarDTO;' +
      '\n' +
      '@RestController\n' +
  ...
  function criarRepository () {
    conteudo =
      ...
      '\n' +
      'import ' + packageName + '.arquitetura.repository.GenericJpaRepository;\n' +
      '\n' +
      '@Repository\n' +
    ...
    conteudo =
      'package ' + packageName + '.app.' + nameFolder + ';\n' +
      '\n' +
      'import ' + packageName + '.arquitetura.repository.GenericCustomRepository;\n' +
      'import ' + packageName + '.arquitetura.controller.PesquisarDTO;' +
      '\n' +
      'public interface ' + nomeTabela + 'RepositoryQuery extends CrudRepository<' + nomeTabela + ', PesquisarDTO> {\n' +
      '}\n'
    ...
    conteudo =
      'package ' + packageName + '.app.' + nameFolder + ';\n' +
      '\n' +
      'import ' + packageName + '.arquitetura.repository.GenericJpaRepositoryImpl;\n' +
      'import ' + packageName + '.arquitetura.controller.PesquisarDTO;\n' +
      'import org.springframework.beans.factory.annotation.Autowired;\n' +
      ...
      '\n' +
      '    @Override\n' +
      '    public PageImpl<' + nomeTabela + '> pesquisarPaginado(PesquisarDTO pesquisarGridDTO, Pageable pageable) {\n' +
      '\n' +
  ...
  function criarService () {
    conteudo =
      ...
      '\n' +
      'import ' + packageName + '.arquitetura.service.GenericServiceImpl;\n' +
      '\n' +
      'import java.util.List;\n' +
      'import java.util.Map;\n' +
      '\n' +
      '@Service\n' +
      'public class ' + nomeTabela + 'ServiceImpl extends GenericServiceImpl<' + nomeTabela + ', PesquisarDTO> {\n' +
      '\n' +
    ...
    conteudo =
      ...
      '' +
      'public interface ' + nomeTabela + 'SaudeService extends IGenericService<' + nomeTabela + ', PesquisarDTO> {}'
...
function criarArquivosFront (fs, casoUso, folderDst, nomeTabela, log) {
  ...
  function criarCadastro () {
    ...
    fs.mkdir(folderCadastro, function (error) {
      ...
      let nomeArquivoCss = 'cadastro-' + casoUso + '.component.css'
      criaArquivo(fs, folderCadastro, nomeArquivoCss, '', log)
  ...
  function criarPesquisa () {
    ...
    fs.mkdir(folderPesquisa, function (error) {
      ...
      conteudo =
        ...
        '  styleUrls: [\'./pesquisa-' + casoUso + '.component.css\'],\n' +
        '  encapsulation: ViewEncapsulation.None,\n' +
      ...
      nomeArquivo = 'pesquisa-' + casoUso + '.component.css'
